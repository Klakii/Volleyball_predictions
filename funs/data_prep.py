''' Following functions are used for data preprocessing and preparation for modelling  '''
...
def calc_teams_place():
    '''
    Calculate statistics such as number of sets won, number of points scored etc coming from the league table for seasons between 2010/2011 and 2023/2024 for all teams. Data is stored in a database as a result from 
    the last game, average from the last three games, and average from the last five games. 
    ...
    Examples
    --------
    >>> calc_teams_place() calculate average statisics for all teams and store them in database 
    ...
    names = ['Aluron', 'AZS Częstochowa', 'Asseco', 'BBTS', 'Bydgoszcz', 'Kielce', 'Szczecin', 'Czarni', 'Lubin', 
            ...
            'Lublin', 'Skra', 'Warsza', 'Nysa', 'Suwałki', 'ZAKSA', 'Gdańsk', 'Hemarpol', 'Barkom']
...
def calc_players_averages():
    '''
    Calculate average height, weight and range for each season between 2010/2011 and 2023/2024 for all teams. Data is stored in a database.
    ...
    Examples
    --------
    >>> calc_players_averages() calculate average players characteristics for all teams and store them in database 
    ...
    names = ['Aluron', 'AZS Częstochowa', 'Asseco', 'BBTS', 'Bydgoszcz', 'Kielce', 'Szczecin', 'Czarni', 'Lubin', 
            'Indykpol', 'GKS', 'Węgiel', 'Będzin', 'Wieluń',
            'Lublin', 'Skra', 'Warsza', 'Nysa', 'Suwałki', 'ZAKSA', 'Gdańsk', 'Hermapol', 'Barkom']
...
def calc_match_stats_averages():
    '''
    Calculate average match statistics such as number of blocks, aces and percentage of reception between 2010/2011 and 2023/2024 for all teams. Data is stored in a database as a result from 
    the last game, average from the last three games, and average from the last five games. 
    ...
    Examples
    --------
    >>> calc_match_stats_averages() calculate average team performance for all teams and store them in database 
    ...
    names = ['Aluron', 'Częstochowa', 'Asseco', 'BBTS', 'Bydgoszcz', 'Kielce', 'Szczecin', 'Czarni', 'Lubin', 
            'Indykpol', 'GKS', 'Węgiel', 'Będzin', 'Wieluń',
            'Lublin', 'Skra', 'Warsza', 'Nysa', 'Suwałki', 'ZAKSA', 'Gdańsk', 'Barkom']
...
def calc_table_stats_averages():
    '''
    Calculate table statistics, such as big 'points' obtained for winning matches by each team between 2010/2011 and 2023/2024. Data is stored in a database.
    Parameters
    ----------
    
    Examples
    --------
    >>> calc_table_stats_averages() calculate table statistics for all teams after each round and stores them in a database 
...
def create_final_database():
    ...
    '''
    Create final database by marging data from all databases created by preprocessing functions.
    Parameters
    ----------
    
    Examples
    --------
    >>> create_final_database() create final set of features used for modelling 
